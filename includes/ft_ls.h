...
# define AVAILABLE_OPTIONS	"Ralrt1ms"
# define OPTION_RR			1
# define OPTION_A			2
# define OPTION_L			4
# define OPTION_R			8
...
# define OPTION_M			64
# define OPTION_S			128
# define OPTION_ITER		256
# define OPTION_NAME		512
# define OPTION_INPUT		1024
...
int 						put_detailed_list(t_ls *ls, uint16_t options, int level, int parent_mode);
